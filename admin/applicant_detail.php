...
<body class="detail-page-body">
    ...
    <div class="container">
        <a href="applicants.php" class="back-link">&larr; Kembali ke Daftar Pelamar</a>
        ...
        <div class="applicant-detail-grid">
            ...
            <div class="action-sidebar">
                <div class="action-card card">
                    ...
                    <form class="action-form" action="applicant_detail.php?id=<?= $application_id ?>" method="POST">
                    ...
                    <?php if (!empty($applicant['resume_path'])): ?>
                        <a href="../uploads/resumes/<?= htmlspecialchars($applicant['resume_path']) ?>" class="btn btn-primary" target="_blank">Unduh Resume (PDF)</a>
                    <?php else: ?>
