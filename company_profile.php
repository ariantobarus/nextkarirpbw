...
<body>
    ...
    <div class="company-profile-header">
        <div class="container">
            <img src="uploads/logos/<?= htmlspecialchars($company['logo']) ?>" alt="Logo <?= htmlspecialchars($company['name']) ?>" class="company-logo-large">
                ...
                <?php if (!empty($jobs)): ?>
                    <?php foreach ($jobs as $job): ?>
                        <div class="card job-card">
                            <img src="uploads/logos/<?= htmlspecialchars($company['logo']) ?>" alt="Logo">
                            <div>
